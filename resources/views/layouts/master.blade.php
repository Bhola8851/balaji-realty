...
<div class="wrapper" id="app">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      <img src="./img/logo.png" alt="LaraStartLogo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Balaji Realty</span>
    </a>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                @if(Gate::check('isAdmin') || Gate::check('isEmployee'))
                ...
                @if(Gate::check('isAdmin') || Gate::check('isEmployee'))
                  <router-link to="/agents" class="nav-link">
                    <i class="fa fa-magnet nav-icon "></i>
                    <p>Assign task</p>
                  </router-link>
                @endif
                ...
                @if(Gate::check('isAdmin') || Gate::check('isEmployee'))
                  <router-link to="/supplier" class="nav-link">
                    <i class="fa fa-parachute-box nav-icon "></i>
                    <p>Assign Supplies</p>
                  </router-link>
                @endif
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2014-2018 <a href="#">UPG Project</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC2LnKcqcsKSOehDo_fM_t81G6Ynxdxufs&libraries=places"
