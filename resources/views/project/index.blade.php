                ...
                <div class="row">
                    <div class="col-md-2 offset-md-10">
                        <div class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" id="project_menu">
                            <li><strong><a href="bungalow">Bungalow</a></strong></li>
                            <li><strong><a href="land">Land</a></strong></li>
                            <li><strong><a href="house">House</a></strong></li>
                            <li><strong><a href="flat">Flat</a></strong></li>
